...
${OBJECTDIR}/Source/Map/MapObject/Building.o: Source/Map/MapObject/Building.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Source/Map/MapObject/Building.o Source/Map/MapObject/Building.cpp

${OBJECTDIR}/Source/Map/MapObject/MapObject.o: Source/Map/MapObject/MapObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source/Map/MapObject
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Source/Map/MapObject/MapObject.o Source/Map/MapObject/MapObject.cpp
...
${OBJECTDIR}/Source/Map/Tile/TileObject/Building.o: Source/Map/Tile/TileObject/Building.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Source/Map/Tile/TileObject/Building.o Source/Map/Tile/TileObject/Building.cpp

${OBJECTDIR}/Source/Map/Tile/TileObject/BuildingTileObject.o: Source/Map/Tile/TileObject/BuildingTileObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source/Map/Tile/TileObject
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Source/Map/Tile/TileObject/BuildingTileObject.o Source/Map/Tile/TileObject/BuildingTileObject.cpp

${OBJECTDIR}/Source/Map/Tile/TileObject/TileObject.o: Source/Map/Tile/TileObject/TileObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source/Map/Tile/TileObject
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Source/Map/Tile/TileObject/TileObject.o Source/Map/Tile/TileObject/TileObject.cpp

${OBJECTDIR}/Source/Map/Tile/TileObject/Tree.o: Source/Map/Tile/TileObject/Tree.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source/Map/Tile/TileObject
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Source/Map/Tile/TileObject/Tree.o Source/Map/Tile/TileObject/Tree.cpp
